package br.com.zupacademy.thiago.mercadolivre.config.security;
...
public class SecurityConfigurations extends WebSecurityConfigurerAdapter {
	...
	public void configure(WebSecurity web) throws Exception {
		web.ignoring().antMatchers("/**.html", "/v2/api-docs", "/webjars/**", "/configuration/**", "/swagger-resources/**", "/notas-fiscais/**", "/ranking/**");
	}
